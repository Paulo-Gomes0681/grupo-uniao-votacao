...
import { Users, Vote, Trophy, CheckCircle, XCircle, Search, LogOut } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <p className="text-center text-gray-600 mb-8">Jardim Atlântico</p>
          ...
          <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-4 rounded-lg font-bold text-lg bg-gray-300 text-gray-700 hover:bg-gray-400 transition"
              >
                Cancelar
              </button>
              <button
            ...
            <div className="mb-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:border-red-500 focus:outline-none text-lg"
                />
              </div>
            </div>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sistema de Votação</p>
          </div>
